...
(async () => {
  await runWithCore(async ({ core, wantsBackground }) => {
    ...
    const topics = [
      ...
      // 追加：クリックしたくなるキーワード（AI・副業・稼ぎ方）
      'ChatGPTで月10万稼ぐ具体的な使い方',
      'AIに書かせて自分は編集だけする記事の作り方',
      '副業でAIを使う時の注意点とルール',
      '無料AIツールだけで始める副業の第一歩',
      'AIでブログ記事を量産するワークフロー',
      'AIと人間の役割分担で質を落とさない方法',
      'AIで収益化するまでの期間と現実的な目標',
      '初心者がAI副業で失敗しない始め方',
      'AIで作ったコンテンツの著作権とガイドライン',
      'AIに任せすぎない「監修」のやり方',
      'AIで効率化して本業の時間を守る方法',
      '副業でAIを使うとバレるか・リスク対策',
      'AIツールの選び方とコスパの良い組み合わせ',
      'AIでYouTube動画の台本を書く方法',
      'AIとNotionでタスク・収益を管理する',
      'AIでSNS投稿を毎日自動で作る設定',
      'AI副業で月5万を安定させるまでの道のり',
      'AIに頼りすぎず再現性を出すコツ',
      'AIで情報発信を始める時のテーマの決め方',
      'AI稼ぎで「続かない」を防ぐ仕組み化',
    ];
    ...
    const patterns = [
      ...
      '【ChatGPTで月10万】具体的な使い方',
      '【AIに書かせる】自分は編集だけする作り方',
      '【副業でAI】注意点とルール',
      '【無料AIだけ】副業の第一歩',
      '【AIでブログ】量産するワークフロー',
      '【AIと人間】役割分担で質を落とさない',
    ...
    const articleConditionsLines = [
      ...
      'タイトルは1行目に「# [実際のタイトル] | 稼ぐ | 副業 | 不労所得 | AI | 自動化」として記載してください。',
