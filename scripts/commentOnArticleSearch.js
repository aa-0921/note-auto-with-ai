...
(async () => {
  await runWithCore(async ({ core, wantsBackground }) => {
    ...
    const commentSuffix = `${selectedSuffixOpeningPhrase}、アイコンかアカウント名のところをクリックして、${selectedSuffixClosingPhrase}`;
